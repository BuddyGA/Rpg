...
public:
	...
	inline RpgPointInt GetMouseCursorPosition() const noexcept
	{
	...
	inline RpgPointInt GetMouseCursorDeltaPosition() const noexcept
	{
	...
	inline RpgPointInt GetMouseWheelValue() const noexcept
	{
